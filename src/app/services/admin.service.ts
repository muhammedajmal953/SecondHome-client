...
export class AdminService {
  ...
  getAllUsers(page:number,limit:number,searchQuery:string): Observable<ApiRes> {
  return this._http.get<ApiRes>(`${this.api}/admin/getAllUsers/${page}/${limit}?searchQuery=${searchQuery}`)
  }
  ...
  getAllVendors(page: number, limit: number,searchQuery:string): Observable<ApiRes>{
    return this._http.get<ApiRes>(`${this.api}/admin/getAllVendors/${page}/${limit}?searchQuery=${searchQuery}`)
  }
